...
public class RIL extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RIL
     */
    public RIL() {
        initComponents();
        this.setLocationRelativeTo(null);
        pnChart.setLayout(new java.awt.BorderLayout());
        JFreeChart lineChart = ChartFactory.createLineChart("Reliance Industries Limited","Year","Stock Price",RILDataset(),PlotOrientation.VERTICAL,true,true,true);
    ...
    private DefaultCategoryDataset RILDataset() {
        // same dataset for line chart and bar chart
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        dataset.addValue(500, "Price", "2016");
        dataset.addValue(525, "Price", "2017");
        dataset.addValue(920, "Price", "2018");
        dataset.addValue(1240, "Price", "2019");
        dataset.addValue(2108, "Price", "2020");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RIL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
