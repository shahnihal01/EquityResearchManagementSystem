 ...
 * @author shahn
 */
public class KMBL extends javax.swing.JFrame {

    /**
     * Creates new form KMBL
     */
    public KMBL() {
        initComponents();
        this.setLocationRelativeTo(null);
        pnChart.setLayout(new java.awt.BorderLayout());
        JFreeChart lineChart = ChartFactory.createLineChart("Kotak Mahindra Bank Limited","Year","Stock Price",KMBLDataset(),PlotOrientation.VERTICAL,true,true,true);
    ...
    private DefaultCategoryDataset KMBLDataset() {
        // same dataset for line chart and bar chart
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        dataset.addValue(750, "Price", "2016");
        dataset.addValue(900, "Price", "2017");
        dataset.addValue(1150, "Price", "2018");
        dataset.addValue(1240, "Price", "2019");
        dataset.addValue(1389, "Price", "2020");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KMBL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
