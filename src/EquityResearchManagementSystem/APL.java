...
public class APL extends javax.swing.JFrame {
    ...
    public APL() {
        ...
        JFreeChart lineChart = ChartFactory.createLineChart("Adani Power Limited","Year","Stock Price",APLDataset(),PlotOrientation.VERTICAL,true,true,true);
    ...
    private DefaultCategoryDataset APLDataset() {
        // same dataset for line chart and bar chart
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        dataset.addValue(28, "Price", "2016");
        dataset.addValue(32, "Price", "2017");
        dataset.addValue(33, "Price", "2018");
        dataset.addValue(40, "Price", "2019");
        dataset.addValue(35, "Price", "2020");
